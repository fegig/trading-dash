/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 0ec3295a735ce554c007c36b87690106)
// Runtime types generated with workerd@1.20251011.0 2025-10-07 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "LiveTradingRoom";
	}
	interface Env {
		CRYPTO_CACHE: KVNamespace;
		RATE_LIMIT: KVNamespace;
		SESSION_COOKIE_NAME: "td_session";
		RESEND_FROM: "JFM <no-reply@notify.jfmcapitals.com>";
		CRYPTOCOMPARE_MAX_REQ_PER_MINUTE: 80;
		...
		LIVE_TRADING: DurableObjectNamespace<import("./src/index").LiveTradingRoom>;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SESSION_COOKIE_NAME" | "RESEND_FROM" | "CRYPTOCOMPARE_MAX_REQ_PER_MINUTE" | "CLOUDFLARE_ENV" | "MYSQL_HOST" | "MYSQL_PORT" | "MYSQL_USER" | "MYSQL_PASSWORD" | "MYSQL_DATABASE" | "RESEND_API_KEY" | "SESSION_SECRET" | "API_KEY" | "FRONTEND_URL" | "CRYPTOCOMPARE_API_KEY" | "CRYPTOCOMPARE_API_KEY_2" | "CORS_ORIGIN" | "FINNHUB_API_KEY">> {}
}
