/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 411a8427c10530e58b21562eef07ba55)
// Runtime types generated with workerd@1.20260317.1 2025-10-27 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/spa-og-worker");
	}
	interface DevelopmentEnv {
		ASSETS: Fetcher;
		SITE_CONFIG_URL: "http://localhost:8787/public/site-config";
	...
	interface ProductionEnv {
		ASSETS: Fetcher;
		SITE_CONFIG_URL: "https://trading-dash-api.fegigtech.workers.dev/public/site-config";
		VITE_ENCRYPTION_KEY: string;
		VITE_API_URL: string;
		VITE_WS_URL: string;
		VITE_API_KEY: string;
	...
	interface Env {
		ASSETS: Fetcher;
		SITE_CONFIG_URL?: "http://localhost:8787/public/site-config" | "https://trading-dash-api.fegigtech.workers.dev/public/site-config";
		VITE_ENCRYPTION_KEY: string;
		VITE_API_URL: string;
		VITE_WS_URL: string;
		VITE_API_KEY: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SITE_CONFIG_URL" | "VITE_ENCRYPTION_KEY" | "VITE_API_URL" | "VITE_WS_URL" | "VITE_API_KEY" | "VITE_APP_URL" | "VITE_APP_ENV" | "VITE_SITE_NAME_FALLBACK">> {}
}
