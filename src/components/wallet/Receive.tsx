    ...
    <div className="gradient-background p-4 rounded-lg flex flex-col space-y-4 min-w-sm max-md:min-w-2xs">
      ...
      <div className="flex flex-col items-center justify-center space-y-6 py-4">
        <div className="bg-white p-4 rounded-lg">
          <QRCodeSVG value={coin.walletAddress} size={160} className="w-40 h-40" ref={qrCodeRef} />
        </div>
      </div>
      ...
      <div className="text-center text-xs text-neutral-400 max-w-xs">
        <p>
          Only send {coin.coinShort} to this address. Sending any other asset may result in
          permanent loss.
        </p>
      </div>
